## Code used to analyse and optimise silhouette scores to inform optimal cluster resolution
## adapted from : https://github.com/kidcancerlab/rrrSingleCellUtils/blob/master/R/silhouette.R
...
optimize_silhouette <- function(sobject,
  ...
  if (.Platform$OS.type == "unix") {
    num_cores <- 1   # dist() is memory-bound; sequential avoids mclapply fork OOM
    output <-
